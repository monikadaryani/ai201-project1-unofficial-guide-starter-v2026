...
QUESTIONS = [
    # {"question": "...", "expects": "..."},
    {"question": "What is cost of laundry?", "expects": "$1.50"}, # I just expect it to return one money information because there are so many answers
    ...
    {"question": "How are walls in Fenwick Court", "expects": "thin"},
]
